...
#include <beginner_tutorials/AveragingAction.h>
...
public:
  ...
  {
    ROS_INFO("analysisCB(%f)", msg->data);
...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<beginner_tutorials::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  beginner_tutorials::AveragingFeedback feedback_;
  beginner_tutorials::AveragingResult result_;
  ros::Subscriber sub_;
};
