...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<beginner_tutorials::FibonacciAction> as_; // NodeHandle instance must be created before this line. Otherwise strange error occurs.
